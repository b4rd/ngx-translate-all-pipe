...
export class TranslateAllPipe implements PipeTransform, OnDestroy {
    ...
    if (isDefined(args[0]) && args.length) {
      if (typeof args[0] === 'string' && args[0].length) {
        ...
        try {
          ...
          throw new SyntaxError(`Wrong parameter in TranslateAllPipe. Expected a valid Object, received: ${args[0]}`);
        }
